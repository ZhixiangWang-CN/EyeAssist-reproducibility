...
| Saliency-transfer multi-metric robustness | `scripts/11_saliency_robustness.py`, `scripts/17_saliency_case_cluster_bootstrap.py` | NSS/CC/KL/sAUC; paired target-fixed contrasts with 20,000 case-cluster resamples retaining repeated partition appearances | implemented/reconstructed |
