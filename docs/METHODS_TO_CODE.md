...
| Saliency-transfer multi-metric robustness | `scripts/11_saliency_robustness.py`, `scripts/17_saliency_case_cluster_bootstrap.py` | NSS/CC/KL/sAUC; repeated predictions averaged within case, then 20,000 equal-case cluster resamples | implemented/reconstructed |
